...
final class PostTable extends PowerGridComponent
{
    ...
    */
     ...
     *
     * @return Builder<\Modules\Post\Models\PostModel>
     */
    ...
    */
    ...
    /**
     * PowerGrid PostModel Action Buttons.
     *
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', 'Edit')
               ...
               ->route('post-model.edit', ['post-model' => 'id']),

           Button::make('destroy', 'Delete')
               ->class('bg-red-500 cursor-pointer text-white px-3 py-2 m-1 rounded text-sm')
               ->route('post-model.destroy', ['post-model' => 'id'])
               ->method('delete')
        ];
    }
    */
    ...
    */
    ...
    /**
     * PowerGrid PostModel Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($post-model) => $post-model->id === 1)
                ->hide(),
        ];
    }
    */
